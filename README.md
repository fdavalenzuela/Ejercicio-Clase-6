...
<html lang="es">
    ...
    <body>
        ...
        <!-- <ol id="instituciones"></ol>-->
		 ...
		 <h2> Reputación Empleados </h2>
		 <ol id="employ"></ol>
		 <h2> Reputación Académica </h2>
		 <ol id="academic"></ol>
        ...
        <script>
            ...
            const uno = document.querySelector("#employ");
            ...
            const URL = "https://api.myjson.online/v1/records/91fa414e-6b86-4acd-b3aa-0c1afb5c5e11";
            ...
            fetch(URL)
                ...
                .then((datos) => {
					...
					if(x.employer_reputation > 75.5) {
                        uno.innerHTML += `<li>${x.name} - ${x.employer_reputation}</li>`;
					} 
					if(x.academic_reputation > 72) {
						otro.innerHTML += `<li>${x.name} - ${x.academic_reputation}</li>`;
					}
                    });
                })
